...
//序章地图
public class InitMap extends Thread implements LevelMap {
	...
	class endploat extends Thread {
		...
		public void run() {
			...
			ploat.setForeground(Color.white);
			ploat.setOpaque(false);
			if (!StringOperation.strWho(new UserInfo().getGrade(), "1") && StringOperation.strWho(User.hp, "0")) {
